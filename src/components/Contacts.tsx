...
const Contacts = () => {
  return (
    <div className="flex flex-col items-center text-center mt-15 overflow-hidden mb-25">
      <div className="contacts flex flex-col max-w-6xl">
        ...
        <div className="linkdin-insta grid grid-cols-2 gap-4 divide-x divide-gray-300 text-xl justify-center">
          <div
