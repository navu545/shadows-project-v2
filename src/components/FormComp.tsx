    ...
    <div className="relative">
      {!thankYou && (
        <div className="rounded-2xl text-center px-10 py-8 min-w-lg mx-auto shadow-xl bg-white min-h-[400px]">
          ...
          <button
            className="px-10 py-3 mt-5 bg-black text-white rounded-full text-sm text-lg cursor-pointer transition-all duration-300 hover:bg-[linear-gradient(to_right,#2597FF,#FFF500)] hover:text-white"
